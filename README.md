...
- [Docker从入门到实践](https://yeasy.gitbooks.io/docker_practice/install/centos.html)

- [Docker官方文档](https://docs.docker.com/develop/develop-images/dockerfile_best-practices/)
...
- [书栈网·Kubernetes中文指南/实践手册 ](https://www.bookstack.cn/read/kubernetes-handbook/concepts-horizontal-pod-autoscaling.md)
...
- [openresty lua api 文档](https://github.com/openresty/lua-nginx-module#nginx-api-for-lua)

- [openresty中文文档](https://doc.openresty.com/zh/overview/)

- [nginx配置在线生成工具](https://nginxconfig.io/)
...
- [lua在线调试工具](http://moonshinejs.org/editor/)
...
- [Python执行过程动画](http://www.pythontutor.com/visualize.html#mode=edit)

- [python3-cookbook](https://python3-cookbook.readthedocs.io/zh_CN/latest/)

- [《Think Python 2e》中译本](https://codingpy.com/books/thinkpython2/index.html)

- [Python Cheatsheet·Python编程范例](https://www.pythonsheets.com/)
...
- [手册网·php中文教程](http://www.shouce.ren/api/view/a/3572)
...
- [shell命令在线解释器](https://explainshell.com/)

- [shell脚本在线监控工具](https://www.shellcheck.net/)

- [awk官方文档](http://www.gnu.org/software/gawk/manual/gawk.html)
...
- [pixijs·前端游戏引擎](https://www.pixijs.com/)
...
- [itellyou.cn](http://www.itellyou.cn/)
...
- [Redis中文文档](https://www.redis.net.cn/order/3657.html)

- [Kafka中文教程](https://www.w3cschool.cn/apache_kafka/apache_kafka_installation_steps.html)

- [Ceph中文文档](http://docs.ceph.org.cn/start/intro/)

- [CentOS中文wiki](https://wiki.centos.org/zh/HowTos)

- [jenkins pipeline中文教程](https://www.w3cschool.cn/jenkins/jenkins-epas28oi.html)

- [mongodb中文文档](https://mongodb-documentation.readthedocs.io/en/latest/installation.html)
...
- [Google 开源项目风格指南](https://zh-google-styleguide.readthedocs.io/en/latest/google-shell-styleguide/contents/)

- [php-fpm 与 Nginx优化总结](https://www.kancloud.cn/digest/php-src/136260)

- [Git 常用资源](http://yansu.org/2014/01/15/general-git-resources.html)

- [SwitchHosts作者博客](https://blog.oldj.net/)
...
- [Dev-ops tools](https://dev-ops-tools.zeef.com/richard.kraayenhagen#block_41685_process-management)

- [Logging Control In W3C httpd](https://www.w3.org/Daemon/User/Config/Logging.html#common-logfile-format)

- [rfc793](https://tools.ietf.org/html/rfc793)

- [Google Trends](https://trends.google.com/trends/)

- [GitHub-Ranking](https://github-ranking.anytao.net/repositories)[figshare-在线数据知识库](https://figshare.com/)

- [MathWorld·在线数学百科全书](http://mathworld.wolfram.com/)

- [scienceworld.wolfram.com](http://scienceworld.wolfram.com/)

- [a-z Animals](https://a-z-animals.com/animals/)

- [openstreetmap](https://www.openstreetmap.org/)

- [传送门-微信公众账号和文章的导航及推荐](https://chuansongme.com/)

- [learnku技术教程社区](https://learnku.com/)
